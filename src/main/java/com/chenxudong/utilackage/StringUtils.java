...
/**
		判断源字符串是否有�?�，空引号也算没�?	String 源字符串	boolean	null = false
		"" = false
		判断源字符串是否有�?�，空引号和空格也算没�??	String 源字符串	boolean	null = false
		"" = false
		" " = false
		判断是否为手机号�?	String 源字符串	boolean	null = false
		" " = false
		"13800138000" = true
		"19203604281" = false
 */
